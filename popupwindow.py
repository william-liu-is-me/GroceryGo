...
def show_AddEventSuccess():
    ...
    popwindow = Popup(title='Event Succeeded', content=window, size_hint=(None, None),
                      size=(400, 400))
    popwindow.open()
...
def show_AddFriendSuccess():
    ...
    popwindow = Popup(title='Operation Succeeded', content=window, size_hint=(None, None),
                      size=(400, 400))
    popwindow.open()
...
def show_RegisterPopupFailed():
    ...
    popwindow = Popup(title='Registration failed', content=window,
                      size_hint=(None, None), size=(400, 400))
    popwindow.open()
